...
def get_args():
    ...
    parser.add_argument('--max-iteration', default=4, type=int)
    ...
    parser.add_argument('--model-struc', default='wide', type=str, choices=['pre', 'wide'])
...
def main():
    ...
    if args.model_struc == 'pre':
        ...
        model = WideResNet(34, 100, widen_factor=10, dropRate=0.0).cuda()
    model.train()
    ...
    if args.model_struc == 'pre':
        ...
        model_test = WideResNet(34, 100, widen_factor=10, dropRate=0.0).cuda()
