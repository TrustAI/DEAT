...
def parse_args():
    ...
    parser.add_argument('data', metavar='DIR',default='/mnt/storage0_8/torch_datasets',
                    help='path to dataset')
    parser.add_argument('--output_prefix', default='free_out', type=str,
                    help='prefix used to define output path')
    parser.add_argument('-c', '--config', default='configs_free.yml', type=str, metavar='Path',
                    help='path to the config file (default: configs_free.yml)')
